...
int** vomitAndCrawl(int rows, int cols, Snake* head, int digestInterval, int numOfRat) {
    // TODO
    int direction_cnt = 0;
    int now_col_dir = 0;
    int now_row_dir = 0;
    int now_row = 0;
    int now_col = 0;
    int mid = digestInterval + ( (numOfRat - digestInterval) / 2 );
    int digCNT = 0;
...
int main()
{
    ...
    int** terrarium = vomitAndCrawl(rows, cols, head, digestInterval, numOfRats);
